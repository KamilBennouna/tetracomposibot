################################################################################
# File Name                      : robot_braitenberg_hateBot.py
# UE                             : LU3IN025 - IA & Jeux - TME01
# Writers                        : BENNOUNA Kamil - 21204602
#                                : NOM Prénom - No_étudiant
# Creation date                  : 29/01/2026
# Last update date               : 29/01/2026 @ 1240
# Description                    : Braitenberg, ignores walls, hates robots (actively
...
class Robot_player(Robot):
    ...
    def step(self, sensors, sensor_view=None, sensor_robot=None, sensor_team=None):
        ...
        ### HateBot-specific behavior ###

        # Converting robot distances to danger levels:
        ...
        # Determining rotation (turn away from robots):
        robot_left  = r_fl + r_l + r_bl
        robot_right = r_fr + r_r + r_br
        rotation = robot_left - robot_right

        # Determining translation (move away from robots):
        robot_front = r_fl + r_f + r_fr
        robot_rear  = r_bl + r_b + r_br
        translation = 0.4 + 0.6*(robot_rear - robot_front) - 0.05
